...
#define PHP_TDENGINE_VERSION "0.1.0" /* Replace with version number for your extension */
...
ZEND_BEGIN_MODULE_GLOBALS(tdengine)
	zend_long  global_value;
	char *global_string;
ZEND_END_MODULE_GLOBALS(tdengine)
*/

/* Always refer to the globals in your function as TDENGINE_G(variable).
   You are encouraged to rename these macros something shorter, see
   examples in any other php module directory.
*/
#define TDENGINE_G(v) ZEND_MODULE_GLOBALS_ACCESSOR(tdengine, v)
